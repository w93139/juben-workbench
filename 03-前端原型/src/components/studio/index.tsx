...
export function Studio({ project, step }: { project: Project; step: number }) {
  ...
  async function start(operation: StudioOperation, target: string) {
    if (locked || requirementsPending) return; setBusy(true); setError(null);
